...
import { Clock, Users, ArrowLeft, BookOpen, MessageSquare, Check, ThumbsDown, Phone } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                 ...
                 <Button variant="outline">נהל זמינות</Button>
            </div>
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <Button size="sm" variant="outline" className="me-auto" asChild><Link href="#">צפה</Link></Button>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
