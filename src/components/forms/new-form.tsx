...
export function NewForm() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      hasMusicMajor: undefined,
      isMajorParticipant: undefined,
      plansTheoryExam: undefined,
  ...
  useEffect(() => {
    if (selectedStudent) {
        form.reset({
            ...
            schoolName: selectedStudent.schoolName || undefined,
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>הוסף את היצירות שיבוצעו ברסיטל.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
