...
const getNotificationPreferencesSchema = (t: any) => z.object({
    preferences: z.object({
        ...
        paymentConfirmed: z.array(z.string()),
        newStudentEnrolled: z.array(z.string()),
...
export function NotificationPreferences() {
    ...
    const notificationTypes: { id: NotificationType, label: string }[] = [
        ...
        { id: 'paymentConfirmed', label: t('paymentConfirmed') },
        { id: 'newStudentEnrolled', label: t('newStudentEnrolled') },
