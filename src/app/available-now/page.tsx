                 ...
                 <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-primary/5 via-background to-background">
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">שיעורים פנויים להיום ומחר</h1>
                            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                מצאו שיעור מוזיקה במחיר מיוחד! הזדמנות חד-פעמית ללמוד מהמורים הטובים ביותר בהנחות של עד 40%.
                            </p>
                        </div>
                    </div>
                </section>
