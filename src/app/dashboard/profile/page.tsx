...
import { Edit, BookOpen, Clock, Music, UserCircle } from "lucide-react";
...
export function StudentProfilePage() {
    ...
    const totalMinutesThisWeek = mockPracticeLogs.reduce((sum, log) => {
        ...
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    {mockPracticeLogs.slice(0,3).map(log => (
